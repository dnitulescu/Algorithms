...
int main(int argc, char *argv[]) {		
	...
	insert_edge(&gh,1,3,7,true);
	insert_edge(&gh,1,4,12,true);
	
	insert_edge(&gh,2,3,9,true);	
	insert_edge(&gh,2,5,7,true);
	
	insert_edge(&gh,3,5,4,true);
	insert_edge(&gh,3,6,3,true);
	insert_edge(&gh,3,4,4,true);
	
	insert_edge(&gh,4,6,7,true);
	
	insert_edge(&gh,5,6,2,true);
	insert_edge(&gh,5,7,5,true);
	
	insert_edge(&gh,6,7,2,true);

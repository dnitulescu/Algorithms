...
int main(int argc, char *argv[]) {		
	...
	insert_edge(&gh,1,2,true);
	insert_edge(&gh,1,3,true);
	insert_edge(&gh,2,5,true);
	insert_edge(&gh,2,9,true);
	insert_edge(&gh,3,5,true);
	print_graph(&gh);
	bfs(&gh,1);
	find_path(1,5,parent);
	printf("sdasdasd %d",gh.nedges);
